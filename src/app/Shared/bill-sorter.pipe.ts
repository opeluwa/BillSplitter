    ...
    if (instanceCheck === 0) {  // type is of UserBillModel[]
      return array.sort((n1, n2) => {
        if (search === 1) {
          ...
          const n1billName = n1.mainBill.billName;
          const n2billName = n2.mainBill.billName;
        ...
        return array.sort((n1, n2) => {
          if (search === 1) {
            ...
            const n1billName = n1.billName;
            const n2billName = n2.billName;
            return n1billName < n2billName ? -1 : 1;
          } else if (search === 4) {
            const n1SharedCost = n1.cost / n1.numOfPayers;
            const n2SharedCost = n2.cost / n1.numOfPayers;
            return n1SharedCost < n2SharedCost ? -1 : 1;
          } else if (search === 5) {
            const n1SharedCost = n1.cost / n1.numOfPayers;
            const n2SharedCost = n2.cost / n1.numOfPayers;
